<template>
  <div class="space-y-4 md:space-y-6 p-4 md:p-6 rounded-lg bg-slate-200 shadow-sm">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
      <div>
        <h1 class="text-xl md:text-2xl font-bold text-gray-800">나의 청소 예약 리스트</h1>
        <p class="text-sm text-gray-500 mt-1">청소 예약 현황과 일정을 확인할 수 있습니다.</p>
      </div>
        ...
        >
          <div class="flex justify-between items-start">
            <div class="space-y-2">
              ...
              <div class="text-sm font-medium text-gray-900">예약번호: {{ item.id }}</div>
            </div>
          ...
          <div class="flex flex-wrap gap-2 pt-2">
            ...
            <span v-else class="flex-1 px-3 py-1.5 text-gray-500 flex items-center justify-center">
        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">청소주기</th>
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">예약일시</th>
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">상태</th>
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">처리</th>
            </tr>
          </thead>
